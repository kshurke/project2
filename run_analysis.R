...
message("Importing original data..")
activities <- read.table(paste0(BaseDirectory, "activity_labels.txt"), header=FALSE, 
                         stringsAsFactors=FALSE)
features <- read.table(paste0(BaseDirectory, "features.txt"), header=FALSE, 
                       stringsAsFactors=FALSE)
message("Origianl data imported.")
